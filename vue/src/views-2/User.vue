<template>
  <div class="user-main">
    ...
    <div
      ...
      @mouseleave="stopDrag"
    >
      <svg class="bg" width="450" height="560">
        <defs>
      ...
      <div class="content" :style="contentPosition">
        <div class="left">
          <div class="photo">
            <img :src="idxPhotoUrl" class="image"  />
          </div>
          <div class="user-text">
    ...
    <div class="container">
      <div class="core">
        ...
        <div class="other" v-show="clickType === 3">
          ...
          <div class="other-right" v-if="otherType === 0">
          ...
          <div class="other-right" v-if="otherType === 1">
          ...
          <div class="other-right" v-if="otherType === 2">
...
import EditList from "@/components-2/EditList.vue";
...
const headerPath = computed(() => {
  return `M0,0 L450,0 450,${headerHeight}Q${c.x},${c.y} 0,${headerHeight}`;
});
